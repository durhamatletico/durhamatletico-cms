...
docker-compose exec php terminus site backup:create durham-atletico.live -n --element=db --keep-for=1
echo "Downloading backup"
docker-compose exec php terminus site backup:get durham-atletico.live -n --element=db --to=database.sql.gz
